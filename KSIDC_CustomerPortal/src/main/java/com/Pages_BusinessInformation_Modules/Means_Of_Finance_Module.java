...
import com.Page_Repositary.Means_Of_Finance;
import com.Utility.Log;


public class Means_Of_Finance_Module extends Base_Class {

	Means_Of_Finance Means_Of_Finance = new Means_Of_Finance();
	
	public boolean Calculation() throws InterruptedException, IOException {
		Login();
		click(Means_Of_Finance.ContinueButton);
		Thread.sleep(2000);
		ScrollUntilElementVisible(Means_Of_Finance.ScrolltoTchnology);
		Thread.sleep(1000);
		try {
		...
		click(Means_Of_Finance.MeansOfFinance);
		...
		Thread.sleep(1000);
		ScrollUntilElementVisible(Means_Of_Finance.scrolltoShare);
		...
		Thread.sleep(1000);
		WebElement AppliedTermLoan = driver.findElement(By.xpath("//input[@class='rz-textbox rz-state-disabled valid form-control input-main']"));
