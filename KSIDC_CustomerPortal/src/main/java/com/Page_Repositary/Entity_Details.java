...
public class Entity_Details {
	...
	public By EntityDetails = By.xpath("//a[normalize-space()='2.2 Entity Details']");

	public By AddEntityButton = By.xpath("//button[normalize-space()='Add Entity']");

	public By EntityHeader = By.xpath("//h4[text()='Entity Details']");

	public By EnterPAN = By.xpath("//input[@placeholder='Company PAN']");

	public By CheckDedupe = By.xpath("//button[normalize-space()='Check Dedupe']");

	public By DedupeVerifiedMessage = By.xpath("//div[@class='rz-growl-message']");

	public By DedupeVerifiedButton = By.xpath("//button[text()='Dedupe Verified']");

	public By EnterInstituteName = By.xpath("//input[@placeholder='Name Of Institution']");

	public By TypeOfOrganization = By.xpath("//label[text()='Type Of Institution Organization']/parent::div");

	public By SelectTypeOfOrganization = By.xpath("//span[text()='Business Entities Created by Statute']");

	public By ClassOfActivity = By.xpath("//label[text()='Class Of Activity']/parent::div");
	...
	public By Pin = By.xpath("//input[@placeholder='Pin']");

	public By Pinlabel = By.xpath("//label[text()='Pin']");
	...
	public By SelectTaluk = By.xpath("//span[text()='Taliparamba']");

	public By DistrictLabel = By.xpath("//label[text()='District']");

	public By EnterInstitutionMobileNo = By.xpath("//input[@placeholder='Institution Mobile']");

	public By EnterInstitutionEmail = By.xpath("//input[@placeholder='Institution Email']");

	public By EnterRatingTest = By.xpath("//input[@placeholder='External Credit Rating Test']");

	public By EnterTIN = By.xpath("//input[@placeholder='TIN']");

	public By EnterTAN = By.xpath("//input[@placeholder='TAN']");

	public By EnterGSTAN = By.xpath("//input[@placeholder='GSTIN']");

	public By CKYCID = By.xpath("//input[@placeholder='CKYC-ID']");

	public By PercentageOfShareholding = By.xpath("//input[@placeholder='Percentage Of Share Holding']");

	public By AddEnterpreneurDetails = By.xpath("//button[normalize-space()='Add Details']");

	public By EnterpreneurHeader = By.xpath("//div[text()='Add Entrepreneurs Details']");
	...
	public By EnterCompanyPAN = By.xpath("//input[@placeholder='PAN']");
	...
	public By ChangeAddresscheckbox = By.xpath(
			"(//div[@class='d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-2'])[1]");

	public By EnterAddress11 = By.xpath("//input[@placeholder='Address Line1']");

	public By EnterAddress1Curraddress = By.xpath("(//input[@placeholder='Address Line1'])[2]");

	public By EnterAddress21 = By.xpath("//input[@placeholder='Address Line2']");

	public By EnterAddress31 = By.xpath("//input[@placeholder='Address Line3']");

	public By Landmark1 = By.xpath("//input[@placeholder='LandMark']");

	public By ScrollToLandmark = By.xpath("(//input[@placeholder='LandMark'])[2]");

	public By Place1 = By.xpath("//input[@placeholder='Place']");

	public By Country = By.xpath("//label[text()='Country']/parent::div");

	public By SelectCountry = By.xpath("(//span[text()='India'])[3]");

	public By State = By.xpath("//label[text()='State']/parent::div");

	public By SelectState = By.xpath("(//span[text()='KERALA'])[2]");
	...
	public By SelectDistrict = By.xpath("(//span[text()='KANNUR'])[2]");

	public By City1 = By.xpath("//label[text()='City']/parent::div");

	public By Cityscroll = By.xpath("(//label[text()='Post'])[1]/parent::div");

	public By SelectCity1 = By.xpath("(//span[text()='Test Data kannur'])[2]");

	public By Post = By.xpath("//label[text()='Post']/parent::div");

	public By SelectPost = By.xpath("(//span[text()='kannur post'])[2]");

	public By Taluk1 = By.xpath("//label[text()='Taluk']/parent::div");

	public By SelectTaluk1 = By.xpath("(//span[text()='Taliparamba'])[3]");
	...
	public By ScrollAutoloadedDistrict = By
			.xpath("(//div[@class='rz-dropdown valid rz-clear form-control input-main'])[3]/parent::div");
	...
	public By AddDetailsButton = By.xpath("(//button[text()='Add Details'])[5]");
	...
	public By AddDetailsForExperiance = By.xpath("(//button[text()='Add Details'])[5]");
	...
	public By SelectAwardReceivedYear = By.xpath("(//span[text()='2022'])[3]");

	public By AddAwardDetails = By.xpath("(//button[text()='Add Details'])[5]");
	...
	public By editSelectAwardReceivedYear = By.xpath("(//span[text()='2023'])[3]");
	...
	public By AddEnterpreneurinEntity = By.xpath("(//button[text()='Add Details'])[4]");
	...
	public By ScrolltoContinue = By.xpath("//span[contains(text(),'Details of Entity (Company, Partnership, LLP etc )')]");
