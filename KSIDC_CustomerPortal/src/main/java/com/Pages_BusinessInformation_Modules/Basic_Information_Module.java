...
//		
	...
	public boolean ValidateNameOfEnterprises() throws InterruptedException {
		...
		WebElement AutoloadedEnterprisesName = driver
				.findElement(By.xpath("//input[@placeholder='Name Of Enterprise']"));
	...
	public boolean ValidateTypeOfOrganization() throws InterruptedException {
		...
		WebElement AutoloadedOrganizationType = driver.findElement(
				By.xpath("//div[@class='rz-dropdown rz-state-disabled valid rz-clear form-select select-main']"));
		System.out.println(
				"Autoloaded Type of organization displayed" + AutoloadedOrganizationType.getAttribute("title"));
	...
	public boolean ValidateOfficialAddress() throws InterruptedException {
		...
		WebElement AutoloadedAddress = driver
				.findElement(By.xpath("//input[@placeholder='Official Address Of Enterprise']"));
