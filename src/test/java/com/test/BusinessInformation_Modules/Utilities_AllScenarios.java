...
import com.Pages_BusinessInformation_Modules.Utilities_Module;
...
public class Utilities_AllScenarios extends Base_Class {
		...
		public void reference() {
			...
			Utilities_Module = new Utilities_Module();
		...
		public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws IOException, InterruptedException {
			...
			try {
				...
				if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
					...
					Log.info("Button visible !");
					boolean Login = Utilities_Module.login();
					...
					boolean NavigatetoProjectCost = Utilities_Module.NavigatetoProjectCost();
					...
					//TC003
					ExtentTestManager.startTest("TC003 : Verify Component 'Utilities' Presence");
					boolean VerifyUtilitiesComponent = Utilities_Module.VerifyUtilitiesComponent();
					ExtentTestManager.getTest().log(Status.PASS, "1. Verify if 'Utilities' component is visible on the page" + VerifyUtilitiesComponent);
					ExtentTestManager.getTest().log(Status.PASS, "'Utilities' component is present" + VerifyUtilitiesComponent);
					
					//TC004
					
					ExtentTestManager.startTest("TC004 : Verify 'Utilities' Component Page Opens");
					boolean AccessUtilitiesComponent = Utilities_Module.AccessUtilitiesComponent();
					ExtentTestManager.getTest().log(Status.PASS, "1. Click on the 'Utilities' component" + AccessUtilitiesComponent);
					ExtentTestManager.getTest().log(Status.PASS, "'Utilities' page opens successfully" + AccessUtilitiesComponent);
					
					//TC005
										
					ExtentTestManager.startTest("TC005 : Verify Correct Heading 'Utilities Details'");
					boolean VerifyUtilitiesHeader = Utilities_Module.VerifyUtilitiesHeader();
					ExtentTestManager.getTest().log(Status.PASS, "1. Verify the page heading" + VerifyUtilitiesHeader);
					ExtentTestManager.getTest().log(Status.PASS, "Heading 'Utilities Details' is present" + VerifyUtilitiesHeader);
					...
					boolean VerifyStageHeading = Utilities_Module.VerifyStageHeading();
					...
					boolean VerifyInformativeMessage = Utilities_Module.VerifyInformativeMessage();
					...
					boolean SkipforNowPresence = Utilities_Module.SkipforNowPresence();
					...
					boolean ClickSkipforNowPresence = Utilities_Module.ClickSkipforNowPresence();
					...
					boolean AddDetailsbuttonPresence = Utilities_Module.AddDetailsbuttonPresence();
					...
					boolean ClickAddDetailsbutton = Utilities_Module.ClickAddDetailsbutton();
					...
					boolean SelectUtilityType = Utilities_Module.SelectUtilityType();
					ExtentTestManager.getTest().log(Status.PASS, "1. Click the Utility Type" + SelectUtilityType);
					ExtentTestManager.getTest().log(Status.PASS, "Select Option from Dropdown" + SelectUtilityType);
					ExtentTestManager.getTest().log(Status.PASS, "Selected option displayed" + SelectUtilityType);

					//TC013
					
					ExtentTestManager.startTest("TC013 - Verify Field for 'Cost For Utility Including GST (?)' Field");
					boolean EnterCost = Utilities_Module.EnterCost(CostForUtilityIncludingGST);
    				...
    				boolean CancelButtonPresence = Utilities_Module.CancelButtonPresence();
    				...
    				boolean SaveAsDraftButtonPresence = Utilities_Module.SaveAsDraftButtonPresence();
    				...
    				boolean SaveAndProceedPresence = Utilities_Module.SaveAndProceedButtonPresence();
    				...
    				boolean ClickSaveAsDraft = Utilities_Module.ClickonSaveAsDraft();
    				...
    				boolean UpdateAndProceed = Utilities_Module.UpdateAndProceed();
    				...
    				boolean DatainGrid = Utilities_Module.DatainGrid();
    				...
    				boolean ValidateContinuebutton = Utilities_Module.ValidateContinuebutton();
    				...
    				boolean clicktocontinue = Utilities_Module.clicktocontinue();
