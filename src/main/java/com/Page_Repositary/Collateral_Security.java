...
public class Collateral_Security {
	...
	public By CollateralSecurity = By.xpath("//a[normalize-space()='5.10 Collateral Security']");
	
	public By AddDetails = By.xpath("//button[@class='button btn-medium secondary w-auto']");
	
	public By TitleHolder = By.xpath("//input[@name='TitleHolder']");
	
	public By RelationWithApplicant = By.xpath("//div[@class='rz-dropdown valid rz-state-empty rz-clear form-select select-main']//following-sibling::label[text()='Relation With Applicant']");
	
	public By Relation = By.xpath("(//li[@role='option'])[45]");
	
	public By Address = By.xpath("//input[@name='Address']");
	
	public By Aadhaar = By.xpath("//input[@name='Aadhaar']");
	
	public By DocNo = By.xpath("//input[@name='DocNo']");
	
	public By SurveyNo = By.xpath("//input[@name='SurveyNo']");
	
	public By ResurveyNo = By.xpath("//input[@name='ResurveyNo']");
	
	public By ExtendOfLandWet = By.xpath("//input[@name='ExtendOfLandWet']");
	
	public By ExtendOfLandDRY = By.xpath("//input[@name='ExtendOfLandDRY']");
	
	public By Unit = By.xpath("//div[@class='rz-dropdown valid rz-state-empty rz-clear form-select select-main']//following-sibling::label[text()='Unit']");
	
	public By DropdownofUnit = By.xpath("(//li[@role='option'])[48]");
	
	public By PinCode = By.xpath("//input[@name='PinCode']");
	
	public By TitleState =By.xpath("//label[@title='State']");
	
	public By State = By.xpath("//label[@title='State']//following-sibling::div");
	
	public By DropdownofState = By.xpath("(//li[@role='option'])[25]");
	
	public By District = By.xpath("//label[@title='District']//following-sibling::div");
